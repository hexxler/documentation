...
\begin{document}
	...
	\par Am Ende des Projekts soll eine fertige, auf \gls{windows} spielbare Version des Spiels verfügbar sein. Der Umfang dieser Version hängt von den Entwicklungsarbeiten und deren Geschwindigkeit ab, soll jedoch mindestens die im Kapitel \nameref{section:FunktionaleAnforderungen} aufgeführten Punkte erfüllen.
