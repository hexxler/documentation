...
\begin{document}
	...
	\subfile{sections/architecture} %EMPTY
	\subfile{sections/external_interfaces} %EMPTY
	\subfile{sections/code} %EMPTY
	\subfile{sections/data} %EMPTY
	\subfile{sections/infrastructure_architecture} %EMPTY
	\subfile{sections/deployment} %EMPTY
	\subfile{sections/operation_support} %EMPTY
